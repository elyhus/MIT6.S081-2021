...
00000000000000a8 <runcmd>:
{
  ...
  exit(0);
    ...
    wait(0);
     ...
     17a:	c66080e7          	jalr	-922(ra) # ddc <wait>
    runcmd(lcmd->right);
    ...
    close(p[0]);
     ...
     1be:	c42080e7          	jalr	-958(ra) # dfc <close>
    close(p[1]);
    ...
    wait(0);
     ...
     1d4:	c0c080e7          	jalr	-1012(ra) # ddc <wait>
    wait(0);
     1d8:	4501                	li	a0,0
     1da:	00001097          	auipc	ra,0x1
     1de:	c02080e7          	jalr	-1022(ra) # ddc <wait>
    break;
     ...
     1fa:	c06080e7          	jalr	-1018(ra) # dfc <close>
      dup(p[1]);
     1fe:	fdc42503          	lw	a0,-36(s0)
     202:	00001097          	auipc	ra,0x1
     206:	c4a080e7          	jalr	-950(ra) # e4c <dup>
      close(p[0]);
     20a:	fd842503          	lw	a0,-40(s0)
     20e:	00001097          	auipc	ra,0x1
     212:	bee080e7          	jalr	-1042(ra) # dfc <close>
      close(p[1]);
     216:	fdc42503          	lw	a0,-36(s0)
     21a:	00001097          	auipc	ra,0x1
     21e:	be2080e7          	jalr	-1054(ra) # dfc <close>
      runcmd(pcmd->left);
     222:	6488                	ld	a0,8(s1)
     ...
     230:	bd0080e7          	jalr	-1072(ra) # dfc <close>
      dup(p[0]);
     234:	fd842503          	lw	a0,-40(s0)
     238:	00001097          	auipc	ra,0x1
     23c:	c14080e7          	jalr	-1004(ra) # e4c <dup>
      close(p[0]);
     ...
     254:	bac080e7          	jalr	-1108(ra) # dfc <close>
      runcmd(pcmd->right);
